...
// Objects for data to change
    // Hourly
    const hourly={labels:["12-1PM", "1-2PM", "2-3PM", "3-4PM", "4-5PM", "5-6PM", "6-7PM"],data:[90, 70, 10, 10, 40, 60, 100],max:200,intervals:25}
    // Daily
    const daily = {labels:["S", "M", "T", "W", "T", "F", "S"],
    data:[120, 190, 50, 20, 30, 200, 240],max:250,intervals:50}
    // Weekly
    const weekly = {labels:['3/31 - 4/6 ', '4/7 - 4/13', '4/14 - 4/20', '4/21 - 4/27', '4/28 - 5/4', '5/5 - 5/11', '5/12 - 5/18', '5/19 - 5/25', '5/26 - 6/1', '6/2 - 6/8', '6/9 - 6/15'],
    data:[500, 750, 1000, 900, 700, 1150, 1250, 1400, 2000, 2100, 1400],max:2500,intervals:500}
    // Monthly
    const monthly = {labels:["JAN", "FEB", "MAR", "APR", "MAY", "JUN"],
    data:[1500, 1500, 1800, 3500, 6200, 6000],max:6500,intervals:1000}
...
const createNewLineChart =objectName =>{
    ...
    const {labels,data,max,intervals} = eval(objectName);
...
function updateTraffic(newLabels,newData,newMax,newIntervals) {
    ...
    const {data,data:{datasets},options:{scales}}=lineChartConfig;
